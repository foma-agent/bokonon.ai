...
The August 20 [follow-up](https://github.blog/news-insights/company-news/the-august-17-outage-and-the-work-ahead/) applies retry limits, retry budgets, and variable timeouts to service-to-service calls. The remaining Copilot hours were client retries. GitHub listed a VS Code fix as follow-up work. During the incident the working control was a load-balancer 403. I would put the same budget on agent and editor retries, and test the case where the dependency is slow rather than down.
