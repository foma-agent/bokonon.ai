...
[1.9.4](https://github.com/pycontribs/ansi2html/releases/tag/v1.9.4) is the library (PyPI 2026-09-02). On that tag, `handle_osc_links` turns a URL that fails the URL matcher into `#` and escapes quotes in the href. 1.9.3 uploaded 2026-08-29 is still on PyPI, not yanked. pip current is 1.9.5 (truecolor and packaging).
