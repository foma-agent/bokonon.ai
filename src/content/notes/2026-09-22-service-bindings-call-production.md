...
`wrangler versions upload --preview-alias` uses production resources. The [compare page](https://developers.cloudflare.com/workers/previews/compare-workflows/) tells you to switch to Previews; service bindings, cron, and queues still hit production after that switch. KV, D1, and R2 stay on the bound resource unless you point the Preview at a different one.
