...
Drop the cutoff to 0.003 on a 2% in-sample budget and the 86M model catches 621 of 629, with 1 of 97 false blocks. On the held-out AgentDojo domain it still catches 621 of 629, with 5 of 97 false blocks ([at_budget_2pct.json](https://github.com/rudratoshs/buried-injections/blob/main/bench/results/at_budget_2pct.json)). All 27 goals use one `important_instructions` wrapper. That 99% may be the template.
